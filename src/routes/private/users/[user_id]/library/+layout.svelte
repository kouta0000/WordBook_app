...
<div id="lib_foot_buttons" class="w-full h-15 md:h-20 fixed absolute bottom-0 flex flex-row gap-3 justify-center bg-white">

    <a href="./wordbooks" class="btn btn-ghost md:hover:bg-base-400 active:bg-base-400 h-15 md:h-20 flex-grow basis-0 md:scale-105" >
    ...
    <div class="h-15 md:h-20 flex-grow basis-0">
        <svg class="h-full scale-150 mx-auto" viewBox="0 0 40 40" >
            ...
            <circle class="fill-stone-300" cx="20" cy="20" r="10" filter="url(#f)" />
    ...
    <a href="./library" class="btn btn-ghost md:hover:bg-base-400 active:bg-base-400 h-15 md:h-20 flex-grow basis-0 md:scale-105">
