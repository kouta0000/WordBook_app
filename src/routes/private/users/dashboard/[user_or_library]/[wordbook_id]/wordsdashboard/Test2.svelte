...
<div id="displays" class="w-full h-screen pt-30 lg:pt-35 pb-30 lg:pb-35 flex flex-col lg:flex-row gap-7 justify-center items-center overflow-clip z-19 relative">
    ...
    {#if showdisplays}
        ...
        <div id="main_display" class="bg-linear-to-br from-gray-950 via-emerald-950 to-gray-950 shadow-2xl shadow-emerald-500 inset-shadow-2xl flex w-4/5 md:w-3/5 lg:w-2/5 lg:ml-5 rounded-3xl border-1 border-emerald-300 text-emerald-500 mb-10 lg:mb-6 relative z-18" in:fly={{duration:300, x:300}} out:fly={{duration:400, x:-500}}>
        ...
        <div id="main_display" class="bg-linear-to-br from-gray-950 via-emerald-950 to-gray-950 shadow-2xl shadow-emerald-500 inset-shadow-2xl flex w-4/5 md:w-3/5 lg:w-2/5 lg:ml-5 rounded-3xl border-1 border-emerald-300 text-emerald-500 mb-3 lg:mb-6 relative z-18" in:fly={{duration:300, x:300}} out:fly={{duration:400, x:-500}}>
            <h1 class="text-shadow-sm text-emerald-300 text-shadow-emerald-300/80 m-auto text-2xl md:text-6xl p-3 lg:p-15">aaaaa</h1>
        </div>
        <div class="w-4/5 lg:w-3/10 aspect-square grid grid-cols-5 z-18">
        {#each blocks as block}
        <div class="flex justify-center items-center bg-linear-to-r from-gray-950 via-emerald-950 to-gray-950 aspect-square border-1 border-emerald-300 shadow-2xl inset-shadow-2xl shadow-emerald-500 bg-black">
            <p class="text-shdow-lg text-shadow-emerald-300/80 text-emerald-500 text-6xl">{block}</p>
        </div>
        {/each}
        </div>
