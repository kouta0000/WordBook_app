...
let { session, supabase } = $derived(data);
    ...
    <div class="h-15 w-full fixed absolute top-0 flex flex-row items-center bg-slate-50 border-b border-base-300 z-12">
        ...
        <div class="dropdown dropdown-end p-4 h-full aspect-square relative">
            <div tabindex="0" role="button" class="size-full">
              <svg class="size-full text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
